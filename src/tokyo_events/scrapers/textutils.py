...
#: Japan Standard Time. A fixed +9 offset on purpose: Japan has no DST,
#: and zoneinfo("Asia/Tokyo") would require the tzdata package on the
#: owner's Windows machine for a constant we can state directly.
